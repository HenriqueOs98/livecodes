...
exports.default = (0, core_1.createPrompt)((config, done) => {
    ...
    (0, core_1.useKeypress)((key) => {
        ...
        if ((0, core_1.isEnterKey)(key)) {
            ...
            setChoices(choices.map((choice) => (Object.assign(Object.assign({}, choice), { checked: selectAll }))));
        }
        else if (key.name === 'i') {
            setChoices(choices.map((choice) => (Object.assign(Object.assign({}, choice), { checked: !choice.checked }))));
        }
        else if ((0, core_1.isNumberKey)(key)) {
            // Adjust index to start at 1
            const position = Number(key.name) - 1;
            // Abort if the choice doesn't exists or if disabled
            if (!choices[position] || ((_a = choices[position]) === null || _a === void 0 ? void 0 : _a.disabled)) {
                return;
            }
    ...
    const allChoices = choices
        ...
        const checkbox = checked ? chalk_1.default.green(figures_1.default.circleFilled) : figures_1.default.circle;
