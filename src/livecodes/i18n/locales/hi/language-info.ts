...
const languageInfo: I18nLangInfoTranslation = {
  ...
  clojurescript: {
    desc: 'ClojureScript <1>Clojure</1> के लिए एक कंपाइलर है जो JavaScript को लक्षित करता है। <2></2>Programe.Tech में, यह ब्राउज़र में <3>Cherry</3> का उपयोग करके चलता है।',
    link: '<1> <2>ClojureScript आधिकारिक वेबसाइट</2> </1> <3> <4>Clojure आधिकारिक वेबसाइट</4> </3> <5> <6>Cherry रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=clojure</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
  ...
  diagrams: {
    ...
    link: '<1> <2>स्टार्टर टेम्पलेट लोड करें</2> </1> <3> <4>Programe.Tech दस्तावेज़ीकरण</4> </3>',
    name: 'आरेख',
  },
  dot: {
    desc: 'Node.js और ब्राउज़रों के लिए सबसे तेज़ + संक्षिप्त जावास्क्रिप्ट टेम्पलेट इंजन।',
    link: '<1> <2>आधिकारिक वेबसाइट</2> </1> <3> <4>Programe.Tech दस्तावेज़ीकरण</4> </3>',
    name: 'doT.js',
  },
  ejs: {
  ...
  eta: {
    ...
    link: '<1><2>आधिकारिक वेबसाइट</2></1> <3> <4>दस्तावेज़ीकरण</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5>',
    name: 'Eta',
  },
  fennel: {
    ...
    link: '<1> <2>Fennel आधिकारिक वेबसाइट</2> </1> <3> <4>Fennel के साथ शुरुआत करना</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'Fennel',
  },
  flow: {
  ...
  haml: {
    ...
    link: '<1><2>Haml आधिकारिक वेबसाइट</2></1> <3> <4>Haml दस्तावेज़ीकरण</4> </3> <5> <6>clientside-haml-js GitHub रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=haml</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9>',
    name: 'Haml',
  },
  handlebars: {
  ...
  jsx: {
    desc: 'Programe.Tech में JSX को TypeScript कंपाइलर का उपयोग करके JavaScript में कंपाइल किया जाता है। डिफ़ॉल्ट रूप से यह JSX रनटाइम के रूप में React का उपयोग करता है।',
    link: '<1> <2>React आधिकारिक वेबसाइट</2> </1> <3> <4>React दस्तावेज़ीकरण में JSX</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5>',
    name: 'JSX',
  },
  julia: {
    desc1: '(Programe.Tech में Julia भाषा समर्थन अभी भी प्रयोगात्मक है)',
    desc2:
  ...
  liquid: {
    ...
    link: '<1> <2>LiquidJS आधिकारिक वेबसाइट</2> </1> <3> <4>LiquidJS दस्तावेज़ीकरण</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5>',
    name: 'LiquidJS',
  },
  livescript: {
  ...
  lua: {
    ...
    link: '<1><2>Lua आधिकारिक वेबसाइट</2></1> <3> <4>Lua दस्तावेज़ीकरण</4> </3> <5> <6>Fengari आधिकारिक वेबसाइट</6> </5> <7> <8>fengari-web GitHub रेपो</8> </7> <9> <10>X को Y मिनटों में सीखें, जहां X=Lua</10> </9> <11> <12>Programe.Tech दस्तावेज़ीकरण</12> </11> <13><14>स्टार्टर टेम्पलेट लोड करें</14></13>',
    name: 'Lua',
  },
  luaWasm: {
    ...
    link: '<1><2>Lua आधिकारिक वेबसाइट</2></1> <3> <4>Lua दस्तावेज़ीकरण</4> </3> <5> <6>Wasmoon GitHub रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=Lua</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'Lua (Wasm)',
  },
  malina: {
  ...
  mjml: {
    ...
    link: '<1><2>MJML आधिकारिक वेबसाइट</2></1> <3> <4>MJML दस्तावेज़ीकरण</4> </3> <5> <6>MJML आधिकारिक टेम्पलेट्स</6> </5> <7> <8>Programe.Tech दस्तावेज़ीकरण</8> </7>',
    name: 'MJML',
  },
  mustache: {
    desc: 'तर्करहित टेम्पलेट्स।',
    link: '<1> <2>आधिकारिक वेबसाइट</2> </1> <3> <4>mustache(5) मैनुअल</4> </3> <5> <6>JavaScript कार्यान्वयन</6> </5> <7> <8>Programe.Tech दस्तावेज़ीकरण</8> </7>',
    name: 'Mustache',
  },
  nunjucks: {
  ...
  php: {
    ...
    link: '<1><2>PHP आधिकारिक वेबसाइट</2></1> <3> <4>PHP दस्तावेज़ीकरण</4> </3> <5> <6>Uniter GitHub रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=PHP</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11><12>स्टार्टर टेम्पलेट लोड करें</12></11>',
    name: 'PHP',
  },
  phpWasm: {
    desc: 'php-wasm का उपयोग करके WebAssembly द्वारा संचालित ब्राउज़र में PHP।',
    link: '<1><2>PHP आधिकारिक वेबसाइट</2></1> <3> <4>PHP दस्तावेज़ीकरण</4> </3> <5> <6>php-wasm GitHub रेपो</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=PHP</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'PHP (Wasm)',
  },
  postgresql: {
  ...
  pug: {
    ...
    link: '<1> <2>Pug दस्तावेज़ीकरण</2> </1> <3> <4>X को Y मिनटों में सीखें, जहां X=Pug</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5>',
    name: 'Pug',
  },
  python: {
    desc: 'Brython का उपयोग करके ब्राउज़र में चलने वाला Python।',
    link: '<1> <2>Python आधिकारिक वेबसाइट</2> </1> <3> <4>Python दस्तावेज़ीकरण</4> </3> <5> <6>Brython दस्तावेज़ीकरण</6> </5> <7> <8>X को Y मिनटों में सीखें, जहां X=Python</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'Python',
  },
  pythonWasm: {
    ...
    link: '<1> <2>Python आधिकारिक वेबसाइट</2> </1> <3> <4>Python दस्तावेज़ीकरण</4> </3> <5><6>Pyodide दस्तावेज़ीकरण</6></5> <7> <8>X को Y मिनटों में सीखें, जहां X=Python</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'Python (Wasm)',
  },
  r: {
    desc: 'WebR का उपयोग करके ब्राउज़र में चलने वाला R।',
    link: '<1> <2>R प्रोजेक्ट की आधिकारिक वेबसाइट</2> </1> <3> <4>R मैनुअल्स</4> </3> <5> <6>डेटा विज्ञान के लिए R (2e)</6> </5> <7> <8>WebR दस्तावेज़ीकरण</8> </7> <9> <10>X को Y मिनट में सीखें, जहाँ X=R</10> </9> <11> <12>Programe.Tech दस्तावेज़ीकरण</12> </11> <13> <14>स्टार्टर टेम्पलेट लोड करें</14> </13>',
    name: 'R',
  },
  react: {
    desc: 'React Compiler एक बिल्ड-टाइम टूल है जो स्वचालित रूप से React ऐप्स को ऑप्टिमाइज़ करता है।',
    link: '<1> <2>React आधिकारिक वेबसाइट</2> </1> <3> <4>React कंपाइलर</4> </3> <5> <6>Programe.Tech दस्तावेज़</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें</8> </7>',
    name: 'रिएक्ट कंपाइलर',
  },
  reactNative: {
    ...
    link: '<1> <2>React की आधिकारिक वेबसाइट</2> </1> <3> <4>React Native वेबसाइट</4> </3> <5> <6>React Native for Web वेबसाइट</6> </5> <7> <8>React Native दस्तावेज़ीकरण</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
    name: 'React Native for Web',
  },
  reactNativeTsx: {
    desc: 'React Native for Web, React Native के कंपोनेंट्स और API का एक सुलभ कार्यान्वयन है जो React DOM के साथ अंतरसंचालनीय है।',
    link: '<1> <2>React की आधिकारिक वेबसाइट</2> </1> <3> <4>React Native वेबसाइट</4> </3> <5> <6>React Native for Web वेबसाइट</6> </5> <7> <8>React Native दस्तावेज़ीकरण</8> </7> <9> <10>TypeScript वेबसाइट</10> </9> <11> <12>TypeScript दस्तावेज़ीकरण</12> </11> <13> <14>Programe.Tech दस्तावेज़ीकरण</14> </13> <15> <16>स्टार्टर टेम्पलेट लोड करें (JSX)</16> </15>',
    name: 'React Native for Web (TypeScript के साथ)',
  },
  reactTsx: {
    desc: 'React Compiler एक बिल्ड-टाइम टूल है जो स्वचालित रूप से React ऐप्स को ऑप्टिमाइज़ करता है।',
    link: '<1> <2>React आधिकारिक वेबसाइट</2> </1> <3> <4>React कंपाइलर</4> </3> <5> <6>TypeScript वेबसाइट</6> </5> <7> <8>TypeScript दस्तावेज़</8> </7> <9> <10>Programe.Tech दस्तावेज़</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें (JSX)</12> </11>',
  ...
  ruby: {
    ...
    link: '<1> <2>Ruby की आधिकारिक वेबसाइट</2> </1> <3> <4>Ruby दस्तावेज़ीकरण</4> </3> <5><6>Opal की आधिकारिक वेबसाइट</6></5> <7> <8>Opal मानक पुस्तकालय CDN</8> </7> <9> <10>X को Y मिनट में सीखें, जहां X=ruby</10> </9> <11> <12>Programe.Tech दस्तावेज़ीकरण</12> </11> <13> <14>स्टार्टर टेम्पलेट लोड करें</14> </13>',
    name: 'Ruby',
  },
  rubyWasm: {
    desc: 'ruby-wasm (CRuby के WebAssembly पोर्ट्स का एक संग्रह) का उपयोग करके ब्राउज़र में चलने वाला Ruby।',
    link: '<1> <2>Ruby की आधिकारिक वेबसाइट</2> </1> <3> <4>Ruby दस्तावेज़ीकरण</4> </3> <5> <6>ruby.wasm वेबसाइट</6> </5> <7><8>CRuby</8></7> <9> <10>X को Y मिनट में सीखें, जहां X=ruby</10> </9> <11> <12>Programe.Tech दस्तावेज़ीकरण</12> </11> <13> <14>स्टार्टर टेम्पलेट लोड करें</14> </13>',
    name: 'Ruby (WASM)',
  },
  sass: {
  ...
  solid: {
    ...
    link: '<1><2>आधिकारिक वेबसाइट</2></1> <3><4>दस्तावेज़ीकरण</4></3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5> <7> <8>स्टार्टर टेम्पलेट लोड करें (TSX)</8> </7>',
    name: 'Solid',
    tsx: {
      desc: 'उपयोगकर्ता इंटरफेस बनाने के लिए एक घोषणात्मक, कुशल और लचीली JavaScript लाइब्रेरी।',
      link: '<1><2>आधिकारिक वेबसाइट</2></1> <3> <4>Solid दस्तावेज़ीकरण</4> </3> <5> <6>TypeScript वेबसाइट</6> </5> <7> <8>TypeScript दस्तावेज़ीकरण</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9> <11> <12>स्टार्टर टेम्पलेट लोड करें</12> </11>',
  ...
  sucrase: {
    ...
    link: '<1> <2>Sucrase आधिकारिक वेबसाइट</2> </1> <3> <4>Sucrase GitHub रेपो</4> </3> <5> <6>Programe.Tech दस्तावेज़ीकरण</6> </5>',
    name: 'Sucrase',
  },
  svelte: {
  ...
  teal: {
    ...
    link: '<1> <2>Teal GitHub रेपो</2> </1> <3> <4>Teal दस्तावेज़</4> </3> <5> <6>Teal ट्यूटोरियल</6> </5> <7> <8>Programe.Tech दस्तावेज़ीकरण</8> </7> <9> <10>स्टार्टर टेम्पलेट लोड करें</10> </9>',
    name: 'Teal',
  },
  tsx: {
    desc: 'JSX में TypeScript। TSX को Programe.Tech में TypeScript कंपाइलर का उपयोग करके JavaScript में कंपाइल किया जाता है। डिफ़ॉल्ट रूप से यह JSX रनटाइम के रूप में React का उपयोग करता है।',
    link: '<1> <2>React आधिकारिक वेबसाइट</2> </1> <3> <4>React दस्तावेज़ीकरण में JSX</4> </3> <5> <6>Typescript दस्तावेज़ीकरण</6> </5> <7> <8>Programe.Tech दस्तावेज़ीकरण</8> </7>',
    name: 'TSX',
  },
  twig: {
    desc: '<2>Twig.js</2> द्वारा PHP टेम्प्लेटिंग भाषा <1>Twig</1> का एक JavaScript कार्यान्वयन।',
    link: '<1> <2>Twig आधिकारिक वेबसाइट</2> </1> <3> <4>Twig दस्तावेज़ीकरण</4> </3> <5> <6>Twig.js रेपो</6> </5> <7> <8>Twig.js दस्तावेज़ीकरण</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9>',
    name: 'Twig',
  },
  typescript: {
  ...
  vue: {
    link: '<1> <2>Vue.js v3 आधिकारिक वेबसाइट</2> </1> <3> <4>Vue3 दस्तावेज़ीकरण</4> </3> <5> <6>Vue3 सिंगल फाइल कंपोनेंट्स</6> </5> <7> <8>Programe.Tech दस्तावेज़ीकरण</8> </7> <9><10>स्टार्टर टेम्पलेट लोड करें</10></9>',
    name: 'Vue3 सिंगल फाइल कंपोनेंट्स',
  },
  vue2: {
    desc: 'vue3-sfc-loader का उपयोग करके लोड किया गया।',
    link: '<1><2>Vue.js आधिकारिक वेबसाइट</2></1> <3> <4>Vue2 दस्तावेज़ीकरण</4> </3> <5> <6>Vue2 सिंगल फाइल कंपोनेंट्स</6> </5> <7> <8>vue3-sfc-loader GitHub रेपो</8> </7> <9> <10>Programe.Tech दस्तावेज़ीकरण</10> </9>',
