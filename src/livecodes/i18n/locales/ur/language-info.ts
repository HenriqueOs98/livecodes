...
const languageInfo: I18nLangInfoTranslation = {
  ...
  react: {
    ...
    link: '<1> <2>React کی سرکاری ویب سائٹ</2> </1> <3> <4>React کمپائلر</4> </3> <5> <6>Programe.Tech دستاویزات</6> </5> <7> <8>ابتدائی سانچہ لوڈ کریں</8> </7>',
  ...
  reactTsx: {
    desc: 'React Compiler ایک بلڈ-ٹائم ٹول ہے جو خود کار طریقے سے React ایپس کو بہتر بناتا ہے۔',
    link: '<1> <2>React کی سرکاری ویب سائٹ</2> </1> <3> <4>React کمپائلر</4> </3> <5> <6>TypeScript ویب سائٹ</6> </5> <7> <8>TypeScript دستاویزات</8> </7> <9> <10>Programe.Tech دستاویزات</10> </9> <11> <12>ابتدائی سانچہ لوڈ کریں (JSX)</12> </11>',
  ...
  sucrase: {
    ...
    link: '<1> <2>Sucrase کی سرکاری ویب سائٹ</2> </1> <3> <4>Sucrase GitHub ریپو</4> </3> <5> <6>Programe.Tech دستاویزات</6> </5>',
    name: 'Sucrase',
  },
  svelte: {
  ...
  teal: {
    ...
    link: '<1> <2>Teal GitHub ریپو</2> </1> <3> <4>Teal دستاویزات</4> </3> <5> <6>Teal ٹیوٹوریل</6> </5> <7> <8>Programe.Tech دستاویزات</8> </7> <9> <10>شروعاتی سانچہ لوڈ کریں</10> </9>',
    name: 'Teal',
  },
  tsx: {
    desc: 'JSX میں TypeScript۔ TSX کو Programe.Tech میں TypeScript کمپائلر کا استعمال کرتے ہوئے جاوا اسکرپٹ میں مرتب کیا جاتا ہے۔ ڈیفالٹ طور پر یہ JSX رن ٹائم کے طور پر React کا استعمال کرتا ہے۔',
    link: '<1> <2>React کی سرکاری ویب سائٹ</2> </1> <3> <4>React میں JSX دستاویزات</4> </3> <5> <6>Typescript دستاویزات</6> </5> <7> <8>Programe.Tech دستاویزات</8> </7>',
    name: 'TSX',
  },
  twig: {
    desc: '<2>Twig.js</2> کے ذریعے <1>Twig</1> PHP ٹیمپلیٹنگ زبان کا ایک جاوا اسکرپٹ نفاذ۔',
    link: '<1> <2>Twig کی سرکاری ویب سائٹ</2> </1> <3> <4>Twig دستاویزات</4> </3> <5> <6>Twig.js ریپو</6> </5> <7> <8>Twig.js دستاویزات</8> </7> <9> <10>Programe.Tech دستاویزات</10> </9>',
    name: 'Twig',
  },
  typescript: {
  ...
  vue: {
    link: '<1> <2>Vue.js v3 کی سرکاری ویب سائٹ</2> </1> <3> <4>Vue3 دستاویزات</4> </3> <5> <6>Vue3 سنگل فائل کمپوننٹس</6> </5> <7> <8>Programe.Tech دستاویزات</8> </7> <9><10>شروعاتی سانچہ لوڈ کریں</10></9>',
    name: 'Vue3 سنگل فائل کمپوننٹس',
  },
  vue2: {
    desc: 'vue3-sfc-loader کا استعمال کرتے ہوئے لوڈ کیا گیا۔',
    link: '<1><2>Vue.js کی سرکاری ویب سائٹ</2></1> <3> <4>Vue2 دستاویزات</4> </3> <5> <6>Vue2 سنگل فائل کمپوننٹس</6> </5> <7> <8>vue3-sfc-loader GitHub ریپو</8> </7> <9> <10>Programe.Tech دستاویزات</10> </9>',
