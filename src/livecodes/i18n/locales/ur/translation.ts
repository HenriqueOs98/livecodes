...
const translation: I18nTranslation = {
  about: {
    blog: {
      text: 'بلاگ',
      title: 'Programe.Tech بلاگ',
    },
    configuration: 'ترتیب',
    credits: {
      heading: 'کریڈٹس',
      para1:
        'Programe.Tech کو اوپن سورس پروجیکٹس، ویب سروسز اور تعاون کنندگان کے ذریعے ممکن بنایا گیا ہے۔ <1> کریڈٹ دیکھیں </1>',
      para2: '© 2024 حاتم حسنی Programe.Tech MIT لائسنس کے تحت لائسنس یافتہ ہے۔',
    },
    documentations: {
      heading: 'دستاویزات',
    },
  ...
  assets: {
    ...
    add: {
      ...
      githubPages: {
        desc: 'اثاثے کو گٹ ہب پیجز پر تعینات کریں۔ فائل کو آپ کے گٹ ہب اکاؤنٹ پر <2>Programe.Tech-assets</2> ریپو کی <1>gh-pages</1> برانچ میں پش کیا جاتا ہے۔ اگر ریپو پہلے سے موجود نہیں ہے تو، ایک عوامی ریپو بنایا جائے گا۔',
        heading: 'گٹ ہب پیجز',
