...
const languageInfo: I18nLangInfoTranslation = {
  ...
  clojurescript: {
    desc: 'ClojureScript - это компилятор для <1>Clojure</1>, который нацелен на JavaScript. <2></2>В Programe.Tech он работает в браузере с использованием <3>Cherry</3>.',
    link: '<1> <2>Официальный сайт ClojureScript</2> </1> <3> <4>Официальный сайт Clojure</4> </3> <5> <6>Репозиторий Cherry</6> </5> <7> <8>Изучите X за Y минут, где X=clojure</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
  ...
  diagrams: {
    ...
    link: '<1> <2>Загрузить стартовый шаблон</2> </1> <3> <4>Документация Programe.Tech</4> </3>',
    name: 'Диаграммы',
  },
  dot: {
    desc: 'Самый быстрый + лаконичный движок шаблонов javascript для Node.js и браузеров.',
    link: '<1> <2>Официальный сайт</2> </1> <3> <4>Документация Programe.Tech</4> </3>',
    name: 'doT.js',
  },
  ejs: {
  ...
  eta: {
    ...
    link: '<1><2>Официальный сайт</2></1> <3> <4>Документация</4> </3> <5> <6>Документация Programe.Tech</6> </5>',
    name: 'Eta',
  },
  fennel: {
    ...
    link: '<1> <2>Официальный сайт Fennel</2> </1> <3> <4>Начало работы с Fennel</4> </3> <5> <6>Документация Programe.Tech</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
    name: 'Fennel',
  },
  flow: {
  ...
  haml: {
    ...
    link: '<1><2>Официальный сайт Haml</2></1> <3> <4>Документация Haml</4> </3> <5> <6>GitHub-репозиторий clientside-haml-js</6> </5> <7> <8>Изучите X за Y минут, где X=haml</8> </7> <9> <10>Документация Programe.Tech</10> </9>',
    name: 'Haml',
  },
  handlebars: {
  ...
  jsx: {
    desc: 'JSX компилируется в JavaScript в Programe.Tech с использованием компилятора TypeScript. По умолчанию он использует React в качестве среды выполнения JSX.',
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>Документация JSX в React</4> </3> <5> <6>Документация Programe.Tech</6> </5>',
    name: 'JSX',
  },
  julia: {
    desc1: '(Поддержка языка Julia в Programe.Tech все еще экспериментальна)',
    desc2:
  ...
  liquid: {
    ...
    link: '<1> <2>Официальный сайт LiquidJS</2> </1> <3> <4>Документация LiquidJS</4> </3> <5> <6>Документация Programe.Tech</6> </5>',
    name: 'LiquidJS',
  },
  livescript: {
  ...
  lua: {
    ...
    link: '<1><2>Официальный сайт Lua</2></1> <3> <4>Документация Lua</4> </3> <5> <6>Официальный сайт Fengari</6> </5> <7> <8>GitHub-репозиторий fengari-web</8> </7> <9> <10>Изучите X за Y минут, где X=Lua</10> </9> <11> <12>Документация Programe.Tech</12> </11> <13><14>Загрузить стартовый шаблон</14></13>',
    name: 'Lua',
  },
  luaWasm: {
    ...
    link: '<1><2>Официальный сайт Lua</2></1> <3> <4>Документация Lua</4> </3> <5> <6>GitHub-репозиторий Wasmoon</6> </5> <7> <8>Изучите X за Y минут, где X=Lua</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'Lua (Wasm)',
  },
  malina: {
  ...
  mjml: {
    ...
    link: '<1><2>Официальный сайт MJML</2></1> <3> <4>Документация MJML</4> </3> <5> <6>Официальные шаблоны MJML</6> </5> <7> <8>Документация Programe.Tech</8> </7>',
    name: 'MJML',
  },
  mustache: {
    desc: 'Шаблоны без логики.',
    link: '<1> <2>Официальный сайт</2> </1> <3> <4>Руководство mustache(5)</4> </3> <5> <6>JavaScript-реализация</6> </5> <7> <8>Документация Programe.Tech</8> </7>',
    name: 'Mustache',
  },
  nunjucks: {
  ...
  php: {
    ...
    link: '<1><2>Официальный сайт PHP</2></1> <3> <4>Документация PHP</4> </3> <5> <6>GitHub-репозиторий Uniter</6> </5> <7> <8>Изучите X за Y минут, где X=PHP</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11><12>Загрузить стартовый шаблон</12></11>',
    name: 'PHP',
  },
  phpWasm: {
    desc: 'PHP в браузере, работающий на WebAssembly, с использованием php-wasm.',
    link: '<1><2>Официальный сайт PHP</2></1> <3> <4>Документация PHP</4> </3> <5> <6>GitHub-репозиторий php-wasm</6> </5> <7> <8>Изучите X за Y минут, где X=PHP</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'PHP (Wasm)',
  },
  postgresql: {
  ...
  pug: {
    ...
    link: '<1> <2>Документация Pug</2> </1> <3> <4>Изучите X за Y минут, где X=Pug</4> </3> <5> <6>Документация Programe.Tech</6> </5>',
    name: 'Pug',
  },
  python: {
    desc: 'Python, работающий в браузере с использованием Brython.',
    link: '<1> <2>Официальный сайт Python</2> </1> <3> <4>Документация Python</4> </3> <5> <6>Документация Brython</6> </5> <7> <8>Изучите X за Y минут, где X=Python</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'Python',
  },
  pythonWasm: {
    ...
    link: '<1> <2>Официальный сайт Python</2> </1> <3> <4>Документация Python</4> </3> <5><6>Документация Pyodide</6></5> <7> <8>Изучите X за Y минут, где X=Python</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'Python (Wasm)',
  },
  r: {
    desc: 'R, работающий в браузере с использованием WebR.',
    link: '<1> <2>Официальный сайт проекта R</2> </1> <3> <4>Руководства по R</4> </3> <5> <6>R для науки о данных (2-е издание)</6> </5> <7> <8>Документация WebR</8> </7> <9> <10>Изучите X за Y минут, где X=R</10> </9> <11> <12>Документация Programe.Tech</12> </11> <13> <14>Загрузить стартовый шаблон</14> </13>',
    name: 'R',
  },
  react: {
    desc: 'React Compiler - это инструмент, работающий только во время сборки, который автоматически оптимизирует приложения React.',
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>React Компилятор</4> </3> <5> <6>Документация Programe.Tech</6> </5> <7> <8>Загрузить стартовый шаблон</8> </7>',
  ...
  reactNative: {
    ...
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>Сайт React Native</4> </3> <5> <6>Сайт React Native for Web</6> </5> <7> <8>Документация React Native</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
    name: 'React Native for Web',
  },
  reactNativeTsx: {
    desc: 'React Native for Web - это доступная реализация компонентов и API React Native, которая совместима с React DOM.',
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>Сайт React Native</4> </3> <5> <6>Сайт React Native for Web</6> </5> <7> <8>Документация React Native</8> </7> <9> <10>Сайт TypeScript</10> </9> <11> <12>Документация TypeScript</12> </11> <13> <14>Документация Programe.Tech</14> </13> <15> <16>Загрузить стартовый шаблон (JSX)</16> </15>',
    name: 'React Native for Web (с TypeScript)',
  },
  reactTsx: {
    desc: 'React Compiler - это инструмент, работающий только во время сборки, который автоматически оптимизирует приложения React.',
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>React Компилятор</4> </3> <5> <6>Сайт TypeScript</6> </5> <7> <8>Документация TypeScript</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон (JSX)</12> </11>',
  ...
  ruby: {
    ...
    link: '<1> <2>Официальный сайт Ruby</2> </1> <3> <4>Документация Ruby</4> </3> <5><6>Официальный сайт Opal</6></5> <7> <8>CDN стандартной библиотеки Opal</8> </7> <9> <10>Изучите X за Y минут, где X=ruby</10> </9> <11> <12>Документация Programe.Tech</12> </11> <13> <14>Загрузить стартовый шаблон</14> </13>',
    name: 'Ruby',
  },
  rubyWasm: {
    desc: 'Ruby, работающий в браузере с использованием ruby-wasm (набора WebAssembly-портов CRuby).',
    link: '<1> <2>Официальный сайт Ruby</2> </1> <3> <4>Документация Ruby</4> </3> <5> <6>Сайт ruby.wasm</6> </5> <7><8>CRuby</8></7> <9> <10>Изучите X за Y минут, где X=ruby</10> </9> <11> <12>Документация Programe.Tech</12> </11> <13> <14>Загрузить стартовый шаблон</14> </13>',
    name: 'Ruby (WASM)',
  },
  sass: {
  ...
  solid: {
    ...
    link: '<1><2>Официальный сайт</2></1> <3><4>Документация</4></3> <5> <6>Документация Programe.Tech</6> </5> <7> <8>Загрузить стартовый шаблон (TSX)</8> </7>',
    name: 'Solid',
    tsx: {
      desc: 'Декларативная, эффективная и гибкая JavaScript-библиотека для создания пользовательских интерфейсов.',
      link: '<1><2>Официальный сайт</2></1> <3> <4>Документация Solid</4> </3> <5> <6>Сайт TypeScript</6> </5> <7> <8>Документация TypeScript</8> </7> <9> <10>Документация Programe.Tech</10> </9> <11> <12>Загрузить стартовый шаблон</12> </11>',
  ...
  sucrase: {
    ...
    link: '<1> <2>Официальный сайт Sucrase</2> </1> <3> <4>GitHub-репозиторий Sucrase</4> </3> <5> <6>Документация Programe.Tech</6> </5>',
    name: 'Sucrase',
  },
  svelte: {
  ...
  teal: {
    ...
    link: '<1> <2>GitHub-репозиторий Teal</2> </1> <3> <4>Документация Teal</4> </3> <5> <6>Учебник по Teal</6> </5> <7> <8>Документация Programe.Tech</8> </7> <9> <10>Загрузить стартовый шаблон</10> </9>',
    name: 'Teal',
  },
  tsx: {
    desc: 'TypeScript в JSX. TSX компилируется в JavaScript в Programe.Tech с использованием компилятора TypeScript. По умолчанию он использует React в качестве среды выполнения JSX.',
    link: '<1> <2>Официальный сайт React</2> </1> <3> <4>Документация по JSX в React</4> </3> <5> <6>Документация Typescript</6> </5> <7> <8>Документация Programe.Tech</8> </7>',
    name: 'TSX',
  },
  twig: {
    desc: 'JavaScript-реализация <1>Twig</1> — языка шаблонов PHP с помощью <2>Twig.js</2>.',
    link: '<1> <2>Официальный сайт Twig</2> </1> <3> <4>Документация Twig</4> </3> <5> <6>Репозиторий Twig.js</6> </5> <7> <8>Документация Twig.js</8> </7> <9> <10>Документация Programe.Tech</10> </9>',
    name: 'Twig',
  },
  typescript: {
  ...
  vue: {
    link: '<1> <2>Официальный сайт Vue.js v3</2> </1> <3> <4>Документация Vue3</4> </3> <5> <6>Одно файловые компоненты Vue3</6> </5> <7> <8>Документация Programe.Tech</8> </7> <9><10>Загрузить стартовый шаблон</10></9>',
    name: 'Однофайловые компоненты Vue3',
  },
  vue2: {
    desc: 'Загружается с использованием vue3-sfc-loader.',
    link: '<1><2>Официальный сайт Vue.js</2></1> <3> <4>Документация Vue2</4> </3> <5> <6>Однофайловые компоненты Vue2</6> </5> <7> <8>GitHub-репозиторий vue3-sfc-loader</8> </7> <9> <10>Документация Programe.Tech</10> </9>',
