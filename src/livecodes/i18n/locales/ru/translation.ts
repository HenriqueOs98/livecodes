...
const translation: I18nTranslation = {
  about: {
    blog: {
      text: 'Блог',
      title: 'Блог Programe.Tech',
    },
    configuration: 'Конфигурация',
    credits: {
      heading: 'Кредиты',
      para1:
        'Programe.Tech стал возможен благодаря проектам с открытым исходным кодом, веб-сервисам и участникам. <1> Посмотреть кредиты </1>',
      para2: '© 2024 Hatem Hosny. Programe.Tech распространяется по лицензии MIT.',
    },
    documentations: {
    ...
    sponsor: {
      text: 'Спонсор',
      title: 'Стать спонсором Programe.Tech',
    },
    twitter: {
      text: '𝕏 / Twitter',
      title: '𝕏 / Twitter',
  ...
  app: {
    ...
    logo: {
      title: 'Programe.Tech: Площадка Для Кода, Которая Просто Работает!',
    },
    projectInfo: {
  ...
  assets: {
    ...
    add: {
      ...
      githubPages: {
        desc: 'Разместить актив на GitHub Pages. Файл будет отправлен в ветку <1>gh-pages</1> репозитория <2>Programe.Tech-assets</2> на вашем аккаунте GitHub. Если репозиторий еще не существует, будет создан публичный репозиторий.',
  ...
  backup: {
    backup: {
      ...
      desc: 'Создайте резервную копию данных Programe.Tech, чтобы их можно было позже восстановить на этом или других устройствах. <1></1> Пожалуйста, ознакомьтесь с <2>документацией</2> для получения подробностей.',
    ...
    restore: {
      desc: 'Восстановите ранее созданную резервную копию данных Programe.Tech. <1></1> Если вы решите заменить текущее содержимое, возможно, вы захотите сначала создать его резервную копию. <2></2> Пожалуйста, ознакомьтесь с <3>документацией</3> для получения подробностей.',
  ...
  generic: {
    ...
    custom: 'Обычай',
    embed: {
      logoHint: 'Редактировать на Programe.Tech 🡕',
    },
    error: {
  ...
  resultMode: {
    linkText: 'Редактирование на Programe.Tech',
  },
  savePrompt: {
  ...
  splash: {
    loading: 'Загрузка Programe.Tech…',
  },
  sync: {
    autoSync: 'Автосинхронизация',
    create: {
      desc: 'Будет создан новый <1>приватный</1> репозиторий. Ваши локальные данные Programe.Tech будут синхронизированы с веткой <2>main</2>.',
      heading: 'Создать новый репозиторий',
      repoName: 'Название репозитория',
    },
    error: {
    ...
    existing: {
      desc: 'Ваши локальные данные Programe.Tech будут синхронизированы с веткой <1>main</1>.',
      heading: 'Существующий репозиторий',
      repoName: 'Название репозитория',
    },
